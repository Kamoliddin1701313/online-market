...
function Navbar() {
  ...
  return (
    <div className="h-[70px] bg-white w-full top-0 left-0 fixed z-30 py-3 xl:px-3 lg:py-4 md:py-[18px] sm:py-3.5">
      <div className="max-w-[1280px] mx-auto flex items-center h-full gap-8 justify-between xl:gap-4 md:gap-2">
        <Link
          href="/"
          className="bg-sidebar-btn-color h-full rounded-[8px] px-2.5 w-1/8 text-center flex items-center border-[2px] border-body-color md:w-[160px] md:px-1"
        >
        ...
        <div className="flex items-center gap-5 h-full w-full xl:gap-3 md:justify-center md:gap-2">
          <div className="h-full">
            <button className="bg-sidebar-btn-color border-[2px] border-body-color cursor-pointer h-full rounded-[8px] flex items-center justify-center px-2.5 lg:px-2 sm:px-2">
              <TbAdjustmentsHorizontal className="text-[24px] lg:text-[19px] sm:text-[16px]" />
            </button>
          </div>
          ...
          <div className="h-full w-full">
            ...
            <form
              className={`flex items-center border-[2px] border-body-color h-full w-full rounded-[25px] overflow-hidden md:hidden`}
            >
              <input
                type="search"
                autoComplete="off"
                placeholder="Mahsulot qidirish..."
                className="pl-5 pr-2 placeholder-[#000] outline-none w-full h-full text-black border-none bg-transparent font-normal lg:pl-3 lg:text-[14px] lg:pr-0"
              />
              <button
                type="button"
                aria-label="Qidirish"
              ...
              >
                <LuSearch className="text-[22px] text-[#000] lg:text-[18px]" />
              </button>
            </form>
          ...
          <button
            ...
            className="flex items-center gap-2 border-[2px] border-body-color h-full rounded-[8px] px-3.5 cursor-pointer bg-sidebar-btn-color duration-300 ease-in lg:px-2.5 lg:text-[14px] md:gap-1 md:text-[12px] sm:px-2"
          >
            <MdAdd />
            <span className="font-normal">Qo'shish</span>
          </button>
        </div>
          ...
          <div className="hidden md:block relative">
            ...
            >
              <Image
                ...
                alt="uzb"
                className="w-[18px] h-[18px] mx-auto sm:w-[16px] sm:h-[16px]"
              />
            </button>
